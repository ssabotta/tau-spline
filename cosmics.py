...
#==============================================================================
    ...
    def findsatstars(self, verbose = None):
        ...
        if verbose:
                print("We have {} saturated stars.".format(nsat))
    ...
    def lacosmiciteration(self, verbose = None):
        ...
        if verbose:
            print("  {} candidate pixels".format(nbcandidates))
...
#         
#             if verbose:
#                 print(" {} candidate pixels not part of saturated stars".format(nbcandidates))
#          
#==============================================================================
        if verbose:
        ...
        if verbose:
            print(" {} remaining candidate pixels".format(nbcosmics))
...
#             
        ...
        if verbose:
            print("  {} pixels detected as cosmics".format(nbfinal))
    ...
    def run(self, maxiter = 4, verbose = False):
        ...
        print("Starting {} L.A.Cosmic iterations ...".format(maxiter))
        for i in range(1, maxiter+1):
            print("Iteration {}".format(i))
            
            iterres = self.lacosmiciteration(verbose=verbose)
            print("{} cosmic pixels ({} new)".format(iterres["niter"], iterres["nnew"]))
...
def fromfits(infilename, hdu = 0, verbose = True):
    ...
    if verbose :
        print("FITS import shape : ({}, {})".format(pixelarrayshape[0], pixelarrayshape[1]))
        print("FITS file BITPIX : {}".format(hdr["BITPIX"]))
...
def tofits(outfilename, pixelarray, hdr = None, verbose = True):
    ...
    pixelarrayshape = pixelarray.shape
    if verbose :
        print("FITS export shape : ({}, {})".format(pixelarrayshape[0], pixelarrayshape[1]))
